=== WP Encryption - No.1 HTTPS plugin & One Click Free SSL Cert, HTTPS Redirect, Security ===
...
= 7.8.5.13 =
* PRO - SSL renewal improvements

= 7.8.5.11 =
* Composer autoload moved to main file
* Capability + nonce checks for restart & plan selection
* plugin check fixes
